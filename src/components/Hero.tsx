...
const Hero = () => {
  return (
    <section id="home" className="pt-32 pb-20 md:py-32 bg-white dark:bg-portfolio-dark">
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 mb-12 md:mb-0 animate-fade-in">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-portfolio-black dark:text-white mb-6">
              Joaquin Jorquia
            </h1>
            <p className="text-portfolio-grey dark:text-gray-300 text-lg md:text-xl mb-8 max-w-lg">
          ...
          <div className="md:w-2/5 animate-fade-in">
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-full border-4 border-white dark:border-portfolio-dark shadow-xl">
                <img 
